...
void ClientConfiguration::setCacheLatestTtlSec(
    std::uint64_t cache_latest_ttl_sec) {
...
void ClientConfiguration::setRetriesMaxWaitMs(
    std::uint32_t retries_max_wait_ms) {
